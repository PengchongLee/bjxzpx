<div align="center">
    ...
    <table width="1100" border="0" cellpadding="0" cellspacing="0" background="images/centerbg.gif" style="border-top-width: 0px; border-bottom-width: 0px; " id="table561">
        ...
        <tr>
            ...
            <td width="270"  valign="top">
                ...
                <div align="center">
                    ...
                    <table height=40 cellspacing=0 cellpadding=0 width=100% border=0 id="table562" bgcolor="#C5001C" style="border-width: 0px">
                        ...
                        <tr>
                            ...
                            <td bordercolor="#e6e6e6" style="border:medium none #e6e6e6; ">
                                ...
                                <table cellspacing=0 cellpadding=0 width=100% border=0 id="table563">
                    ...
                    <table width="100%"  border="0" cellspacing="0" cellpadding="0" id="table564" style="border-top-width: 0px">

                        <tr>

                            <td width="100%" height="58" valign="top" bordercolor="#e6e6e6" style="border:solid 1px #e6e6e6">

                                <table width="100%"  border="0" cellspacing="10" cellpadding="0" id="table565">
                    ...
                    <table id=table566 cellSpacing=0 cellPadding=0 width="100%" border=0 bgcolor="#FFFFFF">
                ...
                <table height=119 cellspacing=0 cellpadding=0 width=100% background=images/lianxiwomen.jpg border=0 id="table567" style="border-width: 0px">
                ...
                <table width="100%"  border="0" cellspacing="0" cellpadding="0" id="table568" style="border-top-width: 0px">

                    <tr>

                        <td width="100%" height="58" valign="top" bordercolor="#e6e6e6" style="border:solid 1px #e6e6e6">

                            <table width="100%"  border="0" cellspacing="10" cellpadding="0" id="table569">
            ...
            <td valign="top" style="border:1px solid #E6E6E6; ">
                ...
                <table height=500 cellspacing=20 cellpadding=0 width="100%" border=0 id="table570">

                    <tbody>

                    <tr valign=top>
                        <?php foreach($data as $k=>$v) {?>
                            <td class="imgresize" align="left" style="float: left;padding-left: 60px;">
                                <!-- 循环数据 -->
                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" style="border-left-width: 0px; border-right-width: 0px; border-bottom-width: 0px" cellspacing="5" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td align="center" bordercolor="#D6D6D6" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-bottom-style: none; border-bottom-width: medium">
                                                        <a href="<?= APP_HOST?>content/info/<?php echo $v['content_id'] ?>" target="_self">
                                                            <font size="3"><?=$v['content_title']?></font></a></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
